...
public class SupermarketProductController {
    ...
    @PostMapping("/supermarketproduct/add")
    ...
    @PutMapping("/supermarketproduct/update")
    ...
    @DeleteMapping("/supermarketproduct/{productId}/{supermarketId}/delete")
